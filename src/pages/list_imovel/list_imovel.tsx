...
import listImovelController from "./list_imovel.controller";
import styles from "./list_imovel.styles";

// Defining the ListImovel component
export default function ListImovel() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                // Calling the listImovelController function to fetch data
                const response = await listImovelController();
    ...
    // Rendering the ListImovel component
    return (
